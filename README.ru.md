...
По умолчанию `5`/`3`/`3` — 36-клавишный сплит 3x5+3. Для 6×4+5 получается 58
клавиш при ширине колонки 16 px; лишние два ряда забираются у графика, и тот
уменьшается с 44 px до 34.
